    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 pt-32">
        ...
        <div className="bg-gradient-to-br from-gray-700 to-indigo-700 p-8 rounded-3xl shadow-lg">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">10. Terms and Conditions</h2>
            <p className="text-gray-300">
              By accessing and using Qurky Q, you agree to abide by our terms and conditions. Users must ensure accurate details while booking services, and any violation may result in account suspension.
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">11. Cancellation and Refund</h2>
            <p className="text-gray-300">
              <ul className="list-disc list-inside mt-2">
                <li>Cancellations must be made at least 24 hours before the appointment to receive a full refund.</li>
                <li>Late cancellations or no-shows may result in partial or no refund based on the service provider's policy.</li>
                <li>Refunds are processed within 7 business days to the original payment method.</li>
              </ul>
            </p>
          </section>

          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">12. Shipping and Delivery</h2>
            <p className="text-gray-300">
              <ul className="list-disc list-inside mt-2">
                <li>We offer nationwide delivery within 5-7 business days.</li>
                <li>Tracking details will be provided once the order is dispatched.</li>
                <li>If an order is delayed due to unforeseen circumstances, we will notify you with updated timelines.</li>
              </ul>
            </p>
          </section>
